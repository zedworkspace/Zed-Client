...
import { otpSchema, signupSchema } from "@/validations/authValidation";
                ...
                <Form className="flex flex-col gap-5">
                  ...
                  <div className="mid flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                      <label className="text-xs text-[#A3A39E] font-semibold">
                        OTP
                      </label>
                      <Field
                        type="text"
                        name="otp"
                        className="bg-[#171717] h-10 rounded-lg text-md px-3"
                  ...
                  <div className="mid flex flex-col gap-5">
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      <span
                        onClick={() =>
                          navigate.replace(
                            `/signin${redirect ? `?redirect=${redirect}` : ""}`
                          )
                        }
